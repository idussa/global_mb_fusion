...
path_spt_anom = os.path.join(path_proj, '2.3_Kriging_spatial_anomalies', 'out_data_'+fog_version+'_review', 'LONG-NORM_spatial_gla_anom_ref_2011-2020')# path to spatial anomaly files
...
out = os.path.join(path, 'out_data_'+fog_version+'_review')
